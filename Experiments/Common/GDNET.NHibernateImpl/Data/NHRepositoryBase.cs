...
namespace GDNET.NHibernateImpl.Data
{
    /// <summary>
    ...
    public abstract class NHRepositoryBase<TEntity, TId> : IDisposable, IRepositoryBase<TEntity, TId> where TEntity : EntityBase<TId>
    {
