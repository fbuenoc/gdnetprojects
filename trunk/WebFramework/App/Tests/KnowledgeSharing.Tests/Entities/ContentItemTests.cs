...
namespace KnowledgeSharing.Tests.Entities
{
    ...
    public class ContentItemTests : NUnitTestBase
    {
        ...
        public void CanAddContentItem()
        {
            ...
            AppDomainRepositories.ContentItem.Save(c1);
            AppDomainRepositories.ContentItem.Save(c2);
            DomainRepositories.RepositoryStrategy.FlushAndClear();

            var listOfContentItems = AppDomainRepositories.ContentItem.GetAll();
            ...
            listOfContentItems = AppDomainRepositories.ContentItem.GetAll();
        ...
        public void CanAddLog()
        {
            ...
            AppDomainRepositories.ContentItem.Save(content0);
            DomainRepositories.RepositoryStrategy.FlushAndClear();

            var content1 = AppDomainRepositories.ContentItem.GetById(content0.Id);
